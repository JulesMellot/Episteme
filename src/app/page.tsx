...
import { DEFAULT_WIKI_LANGUAGE, readPreferredWikiLanguage } from "@/lib/wiki-language";
...
export default function Home() {
  ...
  const popularArticles = [
    { title: "React (software)", category: "Technology" },
    { title: "Next.js", category: "Framework" },
    { title: "Typography", category: "Design" },
    { title: "Philosophy", category: "Humanities" },
    { title: "SpaceX", category: "Space" },
        ...
        <div className="max-w-3xl w-full text-center space-y-10">
          ...
          <div className="space-y-4">
            ...
            <h1 className="text-5xl sm:text-7xl font-bold tracking-tighter text-zinc-900 dark:text-zinc-50 leading-[1.1]">
              ...
              <span className="text-zinc-400 dark:text-zinc-500">beautifully rendered.</span>
            </h1>
            <p className="text-lg sm:text-xl text-zinc-600 dark:text-zinc-400 max-w-2xl mx-auto leading-relaxed">
              A meticulously crafted Wikipedia reader focusing on typography, 
              performance, and absolute focus.
            </p>
          </div>
          ...
          <div className="pt-10 border-t border-zinc-200/50 dark:border-zinc-800/50 max-w-2xl mx-auto w-full">
            <p className="text-sm font-mono text-zinc-500 mb-6 uppercase tracking-widest">Trending Topics</p>
